 ...
 */
@WebServlet("/GetInfoCountryByClub")
public class GetInfoCountryByClub extends HttpServlet
{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        ResultSet aa= Ucc.GetICountryByClub(club);
        //request.setAttribute("players", aa);
        try {
			sqlResult = SqlUtil.getHtmlTable(aa);
			request.setAttribute("sqlResult", sqlResult);
			 RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/DisplayInfoCountryByClub.jsp");
